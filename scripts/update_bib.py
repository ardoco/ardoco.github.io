...
al-folio fields (abbr, html, google_scholar_id, selected, keywords, ...) and the
...
MAILTO = os.environ.get("CROSSREF_MAILTO", "ardoco@lists.kit.edu")
USER_AGENT = f"ardoco.de-bib-updater/1.0 (mailto:{MAILTO})"
